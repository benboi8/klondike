...
import 'package:flame_game/components/foundation_pile.dart';
...
class KlondikeGame extends FlameGame {
  ...
  Future<void> onLoad() async {
    ...
    final piles = List.generate(
      ...
      (i) => TableauPile()
        ..size = cardSize
        ..position = Vector2(cardGap + i * (cardWidth + cardGap), cardHeight + 2 * cardGap)
    );
    ...
    camera.viewfinder.position = Vector2(cardWidth * 3.5 + cardGap * 4, -cardHeight);
